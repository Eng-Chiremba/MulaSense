"""
Django settings for MulaSense project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-&z0nzf0hy^6uk1!vh7hr743aiz4b)2&s*k4l9_869$zldl(^!)')
...
WSGI_APPLICATION = 'MulaSense.wsgi.application'
